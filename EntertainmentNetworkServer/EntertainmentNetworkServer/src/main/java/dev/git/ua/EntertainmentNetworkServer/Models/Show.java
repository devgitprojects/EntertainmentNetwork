...
public class Show extends BaseModel implements java.io.Serializable 
{
	...
	@Column(name = "SHW_STARTDT", length = 7)
	public Date getShwStartDt() 
	{
		return shwStartDt;
	}

	public void setShwStartDt(Date shwStartDt) 
	{
		this.shwStartDt = shwStartDt;
	}

	@Temporal(TemporalType.TIMESTAMP)
	@Column(name = "SHW_ENDDT", length = 7)
	public Date getShwEndDt() 
	{
		return shwEndDt;
	}

	public void setShwEndDt(Date shwEndDt) 
	{
		this.shwEndDt = shwEndDt;
	}

	@Column(name = "SHW_PRICE", nullable = false, precision = 22, scale = 0)
	...
	private Date shwStartDt;
	private Date shwEndDt;
